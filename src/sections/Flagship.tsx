...
export const Flagship = () => {
  return (
    <div className="container mt-12 mb-12 bg-white text-gray-600">
      <div className="mx-auto max-w-[70ch] rounded-md border border-gray-200 bg-gray-100 p-8">
        ...
        <p className="mb-4">
          ...
          without triggering defensiveness in others. Whether you’re requesting
          support, setting boundaries, or giving feedback, the way you deliver
          your message makes all the difference. We’ll explore:
        </p>
        ...
        <ul className="my-4 space-y-2">
          ...
          <li className="ml-12 list-disc">
            What roles you unconsciously play in tricky dynamics (e.g. pleaser,
            fixer, avoider)
          </li>
          <li className="ml-12 list-disc">
